...
static void load_imx258_SPC_Data(void)
{
	...
	{
		if(!read_imx258_eeprom_SPC(0x0CC8,IMX258MIPI_SPC_Data,126))
		{
...
//    unsigned long long *feature_return_para=(unsigned long long *) feature_para;
	...
	switch (feature_id) {
		...
		case SENSOR_FEATURE_GET_PDAF_DATA:
			printk("SENSOR_FEATURE_GET_PDAF_DATA---lhl---\n");
		...
		case SENSOR_FEATURE_GET_PDAF_INFO:
			LOG_INF("SENSOR_FEATURE_GET_PDAF_INFO scenarioId:%llu---lhl---\n", *feature_data);
		...
		case SENSOR_FEATURE_GET_SENSOR_PDAF_CAPACITY:
			LOG_INF("SENSOR_FEATURE_GET_SENSOR_PDAF_CAPACITY scenarioId:%llu--lhl--\n", *feature_data);
