...
#define rpr521_SUCCESS						0
#define rpr521_ERR_I2C						-1
#define rpr521_ERR_STATUS					-3
#define rpr521_ERR_SETUP_FAILURE				-4
#define rpr521_ERR_GETGSENSORDATA			-5
#define rpr521_ERR_IDENTIFICATION			-6

/*******************************general definitions *******************************/
#define RPR521_DRIVER_VER ("1.0.0")
...
//grace modify in 2016.3.4 begin
const unsigned long data0_coefficient[COEFFICIENT] = {6825, 5946, 8131, 8802};
const unsigned long data1_coefficient[COEFFICIENT] = {3459, 2576,  4001,  3057};
const unsigned long judge_coefficient[COEFFICIENT] = { 995,  1533,  2031, 2878}; 
//grace modify in 2016.3.4 end


/************ define register for IC ************//* RPR521 REGSTER */
...
#define ALS_PS_MEASUREMENT_100MS (0x06)
#define ALS_PS_MEASUREMENT_MASK (0x0F)
...
#define PS_ALS_SET_MODE_CONTROL   (PWRON_PS_ALS)// (NORMAL_MODE)
#define PS_ALS_SET_ALSPS_CONTROL  (LEDCURRENT_100MA | ALSGAIN_X2X2)//(LEDCURRENT_100MA | ALSGAIN_X1X1) //grace modify in 2016.3.4
#define PS_ALS_SET_INTR_PERSIST   PSGAIN_X2 | 0X1//(1) //grace modify in 2016.3.4
#define PS_ALS_SET_INTR           (PS_THH_BOTH_OUTSIDE| POLA_ACTIVEL | OUTPUT_LATCH | MODE_PROXIMITY)
#define PS_ALS_SET_PS_TH          (85)//(80)	//(50) //grace modify in 2016.3.4
#define PS_ALS_SET_PS_TL          (35)//(25) //grace modify in 2016.3.4
