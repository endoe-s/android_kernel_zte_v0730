...
#define CUST_EINT_GOODIX_FP_NUM              11
#define CUST_EINT_GOODIX_FP_DEBOUNCE_CN      0
#define CUST_EINT_GOODIX_FP_TYPE							CUST_EINTF_TRIGGER_RISING
#define CUST_EINT_GOODIX_FP_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE

#define CUST_EINT_GSE_1_NUM              26
#define CUST_EINT_GSE_1_DEBOUNCE_CN      0
#define CUST_EINT_GSE_1_TYPE							CUST_EINTF_TRIGGER_RISING
#define CUST_EINT_GSE_1_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE

#define CUST_EINT_EINT_WPC_NUM              42
#define CUST_EINT_EINT_WPC_DEBOUNCE_CN      0
#define CUST_EINT_EINT_WPC_TYPE							CUST_EINTF_TRIGGER_RISING
#define CUST_EINT_EINT_WPC_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE
