...
{
	int i4RetValue1 = 0;
	char puSendCmd8[2] = {0x02, 0x02};
	char puSendCmd9[2] = {0x06, 0x61};
	char puSendCmd10[2] = {0x07, 0x31};
	
	g_pstAF_I2Cclient->addr = 0x0e;
	i4RetValue1 = i2c_master_send(g_pstAF_I2Cclient, puSendCmd8, 2);
	i4RetValue1 = i2c_master_send(g_pstAF_I2Cclient, puSendCmd9, 2);    
	msleep(2);
	i4RetValue1 = i2c_master_send(g_pstAF_I2Cclient, puSendCmd10, 2);
}
