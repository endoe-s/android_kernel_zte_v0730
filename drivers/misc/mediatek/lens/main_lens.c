...
#endif
//lihy
extern void DW9767AF_SetI2Cclent_first(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
//end
static stAF_DrvList g_stAF_DrvList[MAX_NUM_OF_LENS] = {
	...
	{1, AFDRV_DW9767AF, DW9767AF_SetI2Cclient, DW9767AF_Ioctl, DW9767AF_Release},
	#endif
