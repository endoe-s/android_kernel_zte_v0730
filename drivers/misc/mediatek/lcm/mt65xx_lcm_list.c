...
#if defined(NT35532_FHD_DSI_VDO_AUO_TRULY)
	&nt35532_fhd_dsi_vdo_auo_truly_lcm_drv,
#endif		
#if defined(HX8398A_FHD_DSI_VDO_AUO_SKYWORTH)
	&hx8398a_fhd_dsi_vdo_auo_skyworth_lcm_drv,
#endif	
	
#if defined(NT35532_FHD_DSI_VDO_AUO_TXD)
	&nt35532_fhd_dsi_vdo_auo_txd_lcm_drv,
#endif
