...
#define KPOC_USB_VENDOR_ID 0x19D2
#define KPOC_USB_PRODUCT_ID 0x0362
#endif
...
#define PRODUCT_STRING "ZTE Android Phone"
...
#if CONFIG_USB_MU3D_DRV && !defined(CONFIG_USB_MU3D_ONLY_U2_MODE)
