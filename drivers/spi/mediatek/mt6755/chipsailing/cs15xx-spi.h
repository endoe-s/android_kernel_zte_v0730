...
/**********FAE config for customer *********/

#define AUTOGAIN   0             // 1:on ;  0: off
...
/*---------------------------------------------------------------------------*/
#define NAV_UP 	         KEY_UP
#define NAV_DOWN 	       KEY_DOWN
#define NAV_LEFT 	       KEY_LEFT
#define NAV_RIGHT  	     KEY_RIGHT
...
#define CS_DEBUG  1   //0：disable打印log日志    1:enable打印log日志 
#if CS_DEBUG
#if 0   
...
#define SPI_IOC_READER_ENTER	_IO(SPI_IOC_MAGIC, 9)
#define SPI_IOC_READER_EXIT	    _IO(SPI_IOC_MAGIC, 10)
