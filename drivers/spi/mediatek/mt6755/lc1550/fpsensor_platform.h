...
#define     FPSENSOR_FIX_FREQ                   (8000u)
...
#define 	FPSENSOR_PWR_ON			  6
#define 	FPSENSOR_PWR_OFF		  7
/*
...
extern struct mt_chip_conf fpsensor_smt_conf;

extern int fpsensor_data_init(fpsensor_data_t *fpsensor);
extern int fpsensor_data_uninit(void);
...
extern void fpsensor_gpio_test(struct fpsensor_platform_data *pdata);
...
extern int fpsensor_plat_power(int power);	
extern int fpsensor_spidev_dts_init(fpsensor_data_t *fpsensor/*, struct platform_device *pdev*/);
