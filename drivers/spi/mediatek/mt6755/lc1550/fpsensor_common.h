...
//VAL FOR FPSENSOR_ESD
#define FPSENSOR_ESD   0x5A000000
/* -------------------------------------------------------------------- */
/* fpsensor data types                           */
/* -------------------------------------------------------------------- */
typedef enum {
...
extern int fpsensor_set_finger_detect_threshold(fpsensor_data_t *fpsensor,
        int measured_val);
extern int fpsensor_get_finger_DEC_VAL(fpsensor_data_t *fpsensor);

extern int fpsensor_set_esd_val(fpsensor_data_t *fpsensor);
extern int fpsensor_check_esd_val(fpsensor_data_t *fpsensor);
