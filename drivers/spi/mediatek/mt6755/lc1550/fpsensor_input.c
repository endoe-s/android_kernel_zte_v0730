...
#define FPSENSOR_KEY_UP						   KEY_UP
#define FPSENSOR_KEY_DOWN					   KEY_DOWN
#define FPSENSOR_KEY_LEFT				       KEY_LEFT
#define FPSENSOR_KEY_RIGHT                     KEY_RIGHT
#define FPSENSOR_KEY_TOUCH					   KEY_F19
#define FPSENSOR_KEY_LONGTOUCH				   KEY_F20
...
int fpsensor_input_init(fpsensor_data_t *fpsensor)
{
    ...
    if (!error) {
        ...
        set_bit(FPSENSOR_KEY_UP, fpsensor->input_dev->keybit);
        set_bit(FPSENSOR_KEY_DOWN, fpsensor->input_dev->keybit); 
		set_bit(FPSENSOR_KEY_LEFT, fpsensor->input_dev->keybit);
        set_bit(FPSENSOR_KEY_RIGHT, fpsensor->input_dev->keybit);

		set_bit(FPSENSOR_KEY_TOUCH, fpsensor->input_dev->keybit);
        set_bit(FPSENSOR_KEY_LONGTOUCH, fpsensor->input_dev->keybit);
