...
*/
int hct_finger_get_gpio_info(void/*struct platform_device *pdev*/)
{
/*
	struct device_node *node;
	int ret;
	node = of_find_compatible_node(NULL, NULL, "mediatek,ma-fp");
	...
	hct_finger_power_on = pinctrl_lookup_state(hct_finger_pinctrl, "fp_state_pwr_on");
	...
	hct_finger_power_off = pinctrl_lookup_state(hct_finger_pinctrl, "fp_state_pwr_off");
	...
	hct_finger_reset_high = pinctrl_lookup_state(hct_finger_pinctrl, "fp_default");
	...
	hct_finger_int_as_int = pinctrl_lookup_state(hct_finger_pinctrl, "fp_state_eint_as_int");
